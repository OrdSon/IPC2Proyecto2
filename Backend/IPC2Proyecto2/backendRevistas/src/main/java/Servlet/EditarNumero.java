 ...
 * @author ordson
 */
public class EditarNumero extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (model.getArchivo() == null || model.getArchivo().isBlank()) {
            numeroDAO.editarSinArchivo(model);
        }else{
            numeroDAO.editarConArchivo(model);
        }
        response.getWriter().append(converter.toJson(numeroDAO.listarCodigo(model.getCodigo())));
    }
